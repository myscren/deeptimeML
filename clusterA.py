...
data=pd.read_excel('D:/Pycharm/DeeptimeML/Ign/data/O2_NEW.xlsx','Sheet1')
data=data.loc[:,'SiO2':'Ga']
### correlation
...
g=sns.clustermap(data_corr,
               ...
               cbar_kws={"orientation": "horizontal"},cbar_pos=(.4, .85, .55, .06),
...
g.ax_heatmap.set_yticks(np.linspace(0.5,44.5,45))
g.ax_heatmap.set_yticklabels(g.data2d.columns)
g.ax_heatmap.set_xticks(np.linspace(0.5,44.5,45))
